...
public:
	CustomerArrival(double mean = 10.0, Queue<Customer>* queue = NULL, Server * server[] = NULL, Simulator * sim = NULL, int serverCount = 1, int count = 10, double time = 0.0, std::string statusFile = "ArrivalReport.dat" );
...
private:
	...
	Server** S;				// Access to the servers
